"""
Django settings for theresa_eustace project.
...
ROOT_URLCONF = 'theresa_eustace.urls'
...
WSGI_APPLICATION = 'theresa_eustace.wsgi.application'
...
DEFAULT_FILE_STORAGE = 'theresa_eustace.media_storages.MediaStorage'
